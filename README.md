...
2. ### **berlaLocation** - Corrects the issue with the inconsistent time format which Berla uses and converts times to a format accepted by other analysis programs such as ESRI ArcGIS or IBM i2. Converted times are located in a column called DateTime. Original timestamp also included for comparison.
